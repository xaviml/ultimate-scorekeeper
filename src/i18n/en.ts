export const en = {
  ...
  halfTimeEnabled: 'Play a half-time',
  halfCapPlus: 'CAP +1',
  ...
  timeoutDuration: 'time (seconds)',
  timeoutLastFive: 'Allow timeouts in the last 5 minutes of the game',
  setupNoTimeoutsLastFive: 'No timeouts in the last 5 minutes of the game.',
  ...
  injurySubChangeTitle: 'Who is changing?',
  ...
  btnOk: 'OK',
  injurySubOtherHint:
    'The other team is injured, so you may change {count} player. Pick who goes off and who comes on, or skip.',
  injurySubNoChange: 'No change is possible right now.',
  injurySubOffLabel: 'Coming off',
  injurySubOnLabel: 'Coming on',
  injurySubCount: '{off} off · {on} on',
  injurySubSplit: '(off {offFmp} FMP / {offMmp} MMP · on {onFmp} FMP / {onMmp} MMP)',
  injurySubIssueCount: 'A substitution is one for one — that leaves the line a different size.',
  injurySubIssueAllowance: 'This injury allows {count} change.',
  injurySubIssueRatio: 'The markings coming on do not match the ones going off.',
  ...
  lineCountPlain: '{count} in the line',
  ...
  rosterImportFileType: 'Only plain text (.txt) files can be imported, in the format above.',
  rosterImportFound: '{count} players found',
  rosterImportNone: 'Nothing recognised yet.',
  rosterImportNoName: 'No name',
  rosterImportSkipped: "{count} lines couldn't be read and were left out",
  ...
  setupNoHalf: 'No half-time in this game.',
