...
export const ca: typeof en = {
  ...
  linesEnabledHint:
    "Registra la línia que salta a pista a cada punt, perquè l'informe pugui dir qui ha jugat més i com han anat els seus punts. Desactivat, res no canvia.",
  lineSizeLabel: 'Jugadors a pista',
  ...
  lineFixedFemaleLabel: 'FMP a pista',
  ...
  injurySubNoBench: 'Tot el roster ja és a pista.',
  injurySubNoMatch:
    'No hi ha ningú fora de pista amb la mateixa marca MMP/FMP, i un canvi ha de mantenir la proporció de la línia.',
  ...
  lineIssueSize: 'Són {count} a pista, no {size}.',
  ...
  colWon: 'Guanyats',
  colWonFull: 'Punts guanyats estant a pista',
  colLost: 'Perduts',
  colLostFull: 'Punts perduts estant a pista',
  colHolds: 'Holds',
  colBreaks: 'Breaks',
  colTurns: 'Turns',
