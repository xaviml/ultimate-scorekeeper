...
export const ca: typeof en = {
  ...
  halfTimeTitle: 'Half',
  halfTimeEnabled: 'Jugar amb descans',
  halfCapPlus: 'CAP +1',
  ...
  timeoutDuration: 'temps (segons)',
  timeoutLastFive: 'Permetre temps morts en els últims 5 minuts del partit',
  setupNoTimeoutsLastFive: 'No hi ha temps morts en els últims 5 minuts del partit.',
  ...
  // queden en anglès a tots els diccionaris, com les etiquetes lbl*.
  linesTitle: 'Línies',
  linesEnabledLabel: 'Registrar qui juga cada punt',
  linesEnabledHint:
    "Registra la línia que salta al camp a cada punt, perquè l'informe pugui dir qui ha jugat més i com han anat els seus punts. Desactivat, res no canvia.",
  lineSizeLabel: 'Jugadors al camp',
  lineGenderCheckLabel: 'Comprovar la proporció de gènere',
  lineGenderCheckNone: 'No comprovar',
  lineGenderCheckNoneHint:
    'Les línies es registren sense mirar la proporció. Tria això quan el partit porta una proporció que no sempre pots complir.',
  lineGenderCheckRatio: 'Seguir la proporció del partit',
  lineGenderCheckRatioHint:
    'La proporció esperada de cada línia segueix la del partit — {female} FMP i {male} MMP amb {size}, alternant amb la proporció.',
  lineGenderCheckFixed: 'Proporció fixa',
  lineGenderCheckFixedHint: 'La mateixa proporció cada punt, digui el que digui la del partit.',
  lineFixedFemaleLabel: 'FMP al camp',
  lineFixedSplit: '{female} FMP / {male} MMP',
  lineSavedTitle: 'Línies predefinides',
  lineOnlyOnField: 'Només es llisten els jugadors registrats en aquest punt.',
  lineOnlyOnFieldGoal: 'Només es llisten els jugadors registrats en aquell punt.',
  injurySubTitle: 'Qui entra?',
  injurySubChangeTitle: 'Qui canvia?',
  injurySubHint: 'Surt {players}. Tria qui el substitueix, o omet-ho si no entra ningú.',
  injurySubNoBench: 'Tot el roster ja és al camp.',
  injurySubNoMatch:
    'No hi ha ningú fora del camp amb la mateixa marca MMP/FMP, i un canvi ha de mantenir la proporció de la línia.',
  injurySubStaysOn: 'No hi ha qui entri per {players}, així que continua jugant.',
  btnOk: "D'acord",
  injurySubOtherHint:
    "L'altre equip té una lesió, així que pots canviar {count} jugador. Tria qui surt i qui entra, o omet.",
  injurySubNoChange: 'Ara mateix no es pot fer cap canvi.',
  injurySubOffLabel: 'Surten',
  injurySubOnLabel: 'Entren',
  injurySubCount: '{off} surten · {on} entren',
  injurySubSplit: '(surten {offFmp} FMP / {offMmp} MMP · entren {onFmp} FMP / {onMmp} MMP)',
  injurySubIssueCount: 'Un canvi és un per un: així la línia queda amb un nombre diferent.',
  injurySubIssueAllowance: 'Aquesta lesió permet {count} canvi.',
  injurySubIssueRatio: 'Les marques que entren no coincideixen amb les que surten.',
  injurySubSkip: 'Sense canvi',
  lineAddTitle: 'Nova línia',
  lineEditTitle: 'Editar línia',
  lineAddBtn: 'Afegir una línia',
  lineEditSaved: 'Editar {name}',
  lineNameTaken: 'Ja hi ha una línia amb aquest nom.',
  lineMissingPlayers: '{count} ja no són al roster',
  lineSavedEmptySetup:
  ...
  lineDialogTitle: 'Línia — {team}',
  lineModeCurrent: 'Aquest punt',
  lineModeNext: 'Punt següent',
  lineCountOf: '{count} de {size}',
  lineCountPlain: '{count} a la línia',
  lineUnmarked: '{count} sense definir',
  lineIssueSize: 'Són {count} al camp, no {size}.',
  lineIssueRatio: 'Això trenca la proporció que demana aquest punt ({female} FMP / {male} MMP).',
  lineNoRoster: "Afegeix jugadors al roster primer — la línia es tria d'aquí.",
  ...
  lineSaveNamePrompt: 'Nom de la línia',
  lineSaveNamePlaceholder: 'O1, D1, Zona…',
  lineSavedConfirm: 'Desada com a {name}',
  lineDeleteSaved: 'Eliminar {name}',
  lineLoadSaved: 'Carregar {name}',
  ...
  rosterImportHint:
    "Enganxa la llista de jugadors a sota, o tria un fitxer de text amb el mateix format. Un jugador per línia: número i nom, només el nom, o només el número. Afegeix MMP o FMP al final d'una línia per marcar aquest jugador.",
  ...
  setupNoHalf: 'No hi ha descans en aquest partit.',
  ...
  // Les tres vistes de la taula de jugadors, en pastilles només quan el seguiment
  // de línies està actiu. Les capçaleres han de cabre en una taula de l'ample d'un
  // mòbil, així que són abreviatures amb el text complet a `title`.
  viewScoring: 'Anotació',
  viewPlaying: 'Joc',
  viewPossession: 'Possessió',
  colPointsPlayed: 'Pts',
  colPointsPlayedFull: 'Punts jugats',
  colOPoints: 'O',
  colOPointsFull: 'Punts en atac',
  colDPoints: 'D',
  colDPointsFull: 'Punts en defensa',
  colWon: 'Guanyats',
  colWonFull: 'Punts guanyats estant al camp',
  colLost: 'Perduts',
  colLostFull: 'Punts perduts estant al camp',
  colHolds: 'Holds',
  colBreaks: 'Breaks',
  colTurns: 'Turns',
  colTurnsFull: 'Pèrdues en què aquest jugador ha perdut el disc',
  colDefenses: 'D',
  colDefensesFull:
